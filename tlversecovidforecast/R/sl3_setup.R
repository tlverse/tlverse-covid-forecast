...
covariate_list <- function() {
  c("recoveries", "days_quarantine", "quarantine", "days_restrictions", 
    ...
    "delta_recoveries", "continent", "subregion", "tests", "density", 
    "median_age", "urbanpop", "hospital_bed", "smokers", "sex0", "sex14", 
    "sex25", "sex54", "sex64", "sex65plus", "sex_ratio", "lung_disease", 
    "femalelung", "malelung", "obese", "male_obese", "fem_obese", "overweight", 
    "male_overweight", "fem_overweight", "air_year", "air_passengers", 
    "econ_worldrank", "econ_regionrank", "econ_2019score", 
    "econ_propertyrights", "econ_judical", "econ_gov_integrity", 
    "econ_taxburden", "econ_govspending", "econ_fiscalhealth", 
    "econ_businessfreedom", "econ_laborfreedom", "econ_monetaryfreedom", 
    "econ_tradefreedom", "econ_investmentfreedom", "econ_financialfreedom", 
    "econ_tariffrate", "econ_incometaxrate", "econ_corporatetaxrate", 
    "econ_taxburdengdp", "econ_govexpendgdp", "econ_popmills", "econ_gdpbills", 
    "econ_gdpgrowthrate", "econ_yeargdpgrowthrate", "econ_gdppercapita", 
    ...
    "rail_year", "rail_millionpassengerkm", "delta_tests", "delta_density", 
    "delta_median_age", "delta_urbanpop", "delta_hospital_bed", "delta_smokers", 
    "delta_sex0", "delta_sex14", "delta_sex25", "delta_sex54", "delta_sex64", 
    "delta_sex65plus", "delta_sex_ratio", "delta_lung_disease", 
    "delta_femalelung", "delta_malelung", "delta_obese", "delta_male_obese", 
    "delta_fem_obese", "delta_overweight", "delta_male_overweight", 
    ...
    "days", "first_case_date", "tenth_case_date", "hundreth_case_date", 
    "case_days", "case10_days", "case100_days", "max_cases", "log_recoveries", 
    "log_population", "log_area", "log_sars_cases", "log_sars_deaths", 
    "log_sars_recovered", "log_tests", "log_density", "log_median_age", 
    "log_urbanpop", "log_hospital_bed", "log_smokers", "log_sex0", "log_sex14", 
    "log_sex25", "log_sex54", "log_sex64", "log_sex65plus", "log_sex_ratio", 
    "log_lung_disease", "log_femalelung", "log_malelung", "log_obese", 
    "log_male_obese", "log_fem_obese", "log_overweight", "log_male_overweight", 
    "log_fem_overweight", "log_air_passengers", "log_econ_2019score", 
    "log_econ_propertyrights", "log_econ_judical", "log_econ_gov_integrity",
    "log_econ_taxburden", "log_econ_govspending", "log_econ_fiscalhealth", 
    "log_econ_businessfreedom", "log_econ_laborfreedom", 
    "log_econ_monetaryfreedom", "log_econ_tradefreedom", 
    "log_econ_investmentfreedom", "log_econ_financialfreedom", 
    "log_econ_tariffrate", "log_econ_incometaxrate", 
    "log_econ_corporatetaxrate", "log_econ_taxburdengdp", 
    "log_econ_govexpendgdp", "log_econ_popmills", "log_econ_gdpbills", 
    "log_econ_gdppercapita", "log_econ_unemployment", 
